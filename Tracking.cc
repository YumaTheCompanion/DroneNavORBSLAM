    ...
    mpFrameDrawer(pFrameDrawer), mpMapDrawer(pMapDrawer), mpMap(pMap), mnLastRelocFrameId(0)
{
    ...
    cout << "Camera settings file path: " << strSettingPath << endl;
...
cv::Mat Tracking::GrabImageStereo(const cv::Mat &imRectLeft, const cv::Mat &imRectRight, const double &timestamp)
{
    ...
    cv::Mat test(mCurrentFrame.GetCameraCenter());
...
void Tracking::Track()
{
    ...
    //cout << "Info: Track() is called." << "(" << track_count++ << ")" << endl;
    ...
    else
    {
        ...
        if(!mbOnlyTracking)
        {
            ...
            //cout << "Info: Local Mapping is activated." << endl;

            if(mState==OK)
            {
                //cout << "Info: mState==OK." << endl;
            ...
            {
                bOK = Relocalization();
                cout << "Info: bOK = Relocalization();." << endl;
            }
        }
        else
        {
    ...
    if(!mCurrentFrame.mTcw.empty())
    {
        ...
        int fd = ORB_SLAM2::Map::fd;
        cv::Mat test(mCurrentFrame.mpReferenceKF->GetTranslation());
        printf("rows: %d, cols: %d\n", test.rows, test.cols);
        if(fd > 0 && test.rows >= 3 && test.rows >= 1) {        
            std::string result_x = string_format("x: %f\n", test.at<float>(0,0));
            std::string result_y = string_format("y: %f\n", test.at<float>(1,0));
...
void Tracking::StereoInitialization()
{
	...
	//std::cout << "KeyFrame added okan...\n";
        ...
        /*
        mLastFrame = Frame(mCurrentFrame); /// <==== Problem is here!
...
void Tracking::CheckReplacedInLastFrame()
{
    ...
    //mLastFrame.mpReferenceKF->isTcwEmpty();
}
...
{
    cout << "Info: Relocalization entered." << endl;
    ...
    if(!bMatch)
    {
        cout << "Info: Relocalization returns false." << endl;
        return false;
    }
    else
    {
        cout << "Info: Relocalization returns true0." << endl;
